...
public:
    ...
    void
    shrink(unsigned int n)
    {
        _size -= n;
    }

    void
    expand(unsigned int n)
    {
        _size += n;
    }
...
protected:
    ...
    void
    insert(Element * e, Element * p, Element * n)
    {
        p->next(e);
        e->next(n);
        _size++;
...
public:
    ...
    Element *
    search_rank(const Rank_Type & rank)
    {
        Element * e = head();
    ...
    Element *
    remove_rank(const Rank_Type & rank)
    {
...
public:
    ...
    void
    insert_merging(Element * e, Element ** m1, Element ** m2)
    {
    ...
    Element *
    search_decrementing(unsigned int s)
    {
...
private:
    ...
    Element *
    search_left(const Object_Type * obj)
    {
        Element * e = head();
